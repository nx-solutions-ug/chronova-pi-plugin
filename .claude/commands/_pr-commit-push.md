...
4. Run the available quality gates (`bun run lint`, `bun run format:check`, `bun run type-check`) if they are relevant and fast. Skip tests if they need a database or external services.
