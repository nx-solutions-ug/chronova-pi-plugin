...
last_updated: 2026-09-10T02:12:45.164Z
...
1. **oh-my-pi** (`pi-coding-agent` v18+; resolved to `18.1.15` in `package-lock.json`). The plugin is loaded by oh-my-pi through the `omp.extensions` field in `package.json` (see [package.json](../package.json)).
