...
last_updated: 2026-09-09T02:15:09.707Z
...
| `prepublishOnly` | `npm run build` | Build before publishing to npm (run by `semantic-release`'s npm publish step). |
